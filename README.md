...
AWS CLIで各AWSリソースを順番に作成し、VPC、Subnet、Route Table、Security Group、EC2、ALBの依存関係を確認します。

- 初期設定:[初期設定](./01-aws-cli/notes/00_aws_cli_initial_setup.md)
- 詳細: [01 AWS CLI & Shell Script](./01-aws-cli/README.md)
- 解説: [01-aws-cli/notes](./01-aws-cli/notes)
- スクリプト: [01-aws-cli/scripts](./01-aws-cli/scripts)
- 設計仕様書:[設計仕様書](./docs/Design_Specification.md)
- 保守運用計画書:[保守運用計画書](./docs/Operation_Design.md)
...
Dockerによるアプリケーション実行環境を整理し、AWS環境におけるKubernetesネットワーク、Service、Ingress、ロードバランサー連携について検証します。
